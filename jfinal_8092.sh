...
# JAVA_OPTS="-Dundertow.port=8031 -Dundertow.host=0.0.0.0"
# 设置时区为东7区(泰国时间)
JAVA_OPTS="-Duser.timezone=GMT+8 -Dundertow.port=8092 -Dundertow.host=0.0.0.0"
# 生成 class path 值
