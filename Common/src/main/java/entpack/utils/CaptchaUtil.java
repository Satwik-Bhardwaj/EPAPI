...
public class CaptchaUtil extends Render {
    ...
    protected static String captchaName = "_jfinal_my_captcha";
    protected static Random random = new Random(System.nanoTime());

    // 默认的验证码大小
    protected static final int WIDTH = 108, HEIGHT = 40;
    // 验证码随机字符数组
    protected static final char[] charArray = "345679ACDEFGHJKMNPQRSTUVWXY".toCharArray();
    // 验证码字体
    protected static final Font[] RANDOM_FONT = new Font[]{
            ...
            new Font(Font.MONOSPACED, Font.BOLD, 38)
    };
